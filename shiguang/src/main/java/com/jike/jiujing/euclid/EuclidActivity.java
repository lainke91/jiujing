package com.jike.jiujing.euclid;
...
import com.jike.jiujing.GameListActivity;
 ...
 */
public abstract class EuclidActivity extends BaseActivity {
...
//    protected View mButtonProfile;
    ...
    protected int getLayoutId() {
        return R.layout.activity_euclid;
    }
...
//        });
        ...
        String title = getIntent().getStringExtra(GameListActivity.PARAM_TITLE);
     ...
     */
    private Animator getAvatarRevealAnimator() {
        ...
        final Animator mRevealAnimator = ViewAnimationUtils.createCircularReveal(
